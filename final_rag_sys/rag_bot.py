...
pdf_path = "../data/post_ocr.pdf"
pptx_path = "../data/kg-paulo.pptx"
md_path = "../data/devops-roadmap.md"
...
# Process Markdown if it exists
if os.path.exists(md_path):
    try:
        md_elements = partition_md(filename=md_path)
    except Exception as e:
...
all_elements = pdf_elements + pptx_elements + md_elements

if not all_elements:
    print("No documents were successfully processed. Please check your data files.")
    exit(1)

# Chunk the documents by title
elements = chunk_by_title(all_elements)
